...
<div id="main_container">
	<h1 id="page_title">
		<spring:message code="word.roomManagers" />
	</h1>
	<c:choose>
		<c:when test="${isBookableRoomPKIncorrect.equals(true)}">
			<div class="error">
		...
		<c:otherwise>
			<nav id="context_menu">
				<a href="<c:url value="/campus/manage?campus_id=${campusId}" />"><spring:message
					...
					href="<c:url value="/room-manager/new?campus_id=${campusId}&building_id=${buildingId}&room_id=${roomId}" />"><spring:message
						code="word.newRoomManager" /></a>
