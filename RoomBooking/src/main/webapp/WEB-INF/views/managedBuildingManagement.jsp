...
<div id="main_container">
	...
	<c:choose>
		...
		<c:otherwise>
			<nav id="context_menu">
				<a class="button"
					href="<c:url value="/confirmer/campus/manage?campus_id=${building.id.campusId}" />"><spring:message
						code="word.campus" /></a> &raquo; <a class="button"
					href="<c:url value="/confirmer/building?campus_id=${building.id.campusId}" />"><spring:message
						code="word.buildings" /></a> &raquo; <a class="button"
					href="<c:url value="/confirmer/room?campus_id=${building.id.campusId}&building_id=${building.id.buildingId}" />"><spring:message
						code="word.rooms" /></a>
