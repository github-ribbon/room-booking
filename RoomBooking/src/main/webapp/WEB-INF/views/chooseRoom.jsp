...
<div id="main_container">
	<h1 id="page_title">
		<spring:message code="title.choosingRoom" />
	</h1>
	<c:choose>
		...
		<c:otherwise>
			<nav id="context_menu">
				<sec:authorize access="hasRole('ROLE_ADMIN')">
					<a
						href="<c:url value="/room/new?campus_id=${campusId}&building_id=${buildingId}" />"
						target="_blank"><spring:message code="word.newRoom" /></a>
				</sec:authorize>
			</nav>
			<div class="content">
				<c:choose>
