...
<div id="main_container">
	...
	<c:choose>
		...
		<c:otherwise>
			<nav id="context_menu">
				<a class="button"
					href="<c:url value="/campus/manage?campus_id=${campusId}" />"><spring:message
					...
					href="<c:url value="/room?campus_id=${campusId}&building_id=${buildingId}" />"><spring:message
						code="word.rooms" /></a> &raquo; <a class="button"
					href="<c:url value="/room/manage?campus_id=${campusId}&building_id=${buildingId}&room_id=${roomId}" />"><spring:message
						code="word.room" /></a> &raquo; <a
					href="<c:url value="/room-attribute/new?campus_id=${campusId}&building_id=${buildingId}&room_id=${roomId}" />"><spring:message
						code="word.newAttributeForRoom" /></a>
						...
						<div class="table_container">
							<table class="buttons_included">
								...
								<c:forEach items="${roomAttributes}" var="item">
									<tr>
										<td>
											<form action="<c:url value="/room-attribute/manage" />"
												method="get">
