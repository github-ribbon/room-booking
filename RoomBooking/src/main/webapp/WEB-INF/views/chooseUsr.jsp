...
<div id="main_container">
	<h1 id="page_title">
		<spring:message code="title.choosingUser" />
	</h1>
	<nav id="context_menu">
		<a href="<c:url value="/usr/new" />" target="_blank"><spring:message
				code="word.newUser" /></a>
	</nav>
	<div class="content">
		<c:choose>
			<c:when test="${empty usrs}">
