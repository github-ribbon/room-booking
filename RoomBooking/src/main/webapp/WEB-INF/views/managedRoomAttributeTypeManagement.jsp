...
<div id="main_container">
	...
	<c:choose>
		...
		<c:otherwise>
			<nav id="context_menu">
				<a
					href="<c:url value="/confirmer/room/by-room-attribute-type?room_attribute_type_id=${roomAttributeType.id.roomAttributeTypeId}" />"><spring:message
						code="word.rooms" /></a>

			</nav>
			<div class="content">
				<c:url value="/confirmer/room-attribute-type/manage" var="url" />
