...
<div id="main_container">
	<h1 id="page_title">
		<spring:message code="word.personGroupPersons" />
	</h1>
	<c:choose>
		...
		<c:otherwise>
			<nav id="context_menu">
				<a class="button"
					href="<c:url value="/person-group/manage?person_group_id=${personGroupId}" />"><spring:message
						code="word.personGroup" /></a> &raquo; <a
					href="<c:url value="/person-group-person/new?person_group_id=${personGroupId}" />"><spring:message
