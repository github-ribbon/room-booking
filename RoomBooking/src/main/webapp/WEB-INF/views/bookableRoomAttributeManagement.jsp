...
<div id="main_container">
	...
	<c:choose>
		...
		<c:otherwise>
			<nav id="context_menu">
				<a class="button"
					href="<c:url value="/client/campus/manage?campus_id=${roomAttribute.id.campusId}" />"><spring:message
						code="word.campus" /></a> &raquo; <a class="button"
					href="<c:url value="/client/building?campus_id=${roomAttribute.id.campusId}" />"><spring:message
						code="word.buildings" /></a> &raquo; <a class="button"
					href="<c:url value="/client/building/manage?campus_id=${roomAttribute.id.campusId}&building_id=${roomAttribute.id.buildingId}" />"><spring:message
						code="word.building" /></a> &raquo; <a class="button"
					href="<c:url value="/client/room?campus_id=${roomAttribute.id.campusId}&building_id=${roomAttribute.id.buildingId}" />"><spring:message
						code="word.rooms" /></a> &raquo; <a class="button"
					href="<c:url value="/client/room/manage?campus_id=${roomAttribute.id.campusId}&building_id=${roomAttribute.id.buildingId}&room_id=${roomAttribute.id.roomId}" />"><spring:message
						code="word.room" /></a> &raquo; <a class="button"
					href="<c:url value="/client/room-attribute?campus_id=${roomAttribute.id.campusId}&building_id=${roomAttribute.id.buildingId}&room_id=${roomAttribute.id.roomId}&room_attribute_type_id=${roomAttribute.id.roomAttributeTypeId}" />"><spring:message
						code="word.roomAttributes" /></a>


			</nav>
			<div class="content">
				<c:url value="/client/room-attribute/manage" var="url" />
