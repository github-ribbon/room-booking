...
<div id="main_container">
	...
	<c:choose>
		...
		<c:otherwise>
			<nav id="context_menu">
				<a class="button"
					href="<c:url value="/confirmer/campus/manage?campus_id=${room.id.campusId}" />"><spring:message
						code="word.campus" /></a> &raquo; <a class="button"
					href="<c:url value="/confirmer/building?campus_id=${room.id.campusId}" />"><spring:message
						code="word.buildings" /></a> &raquo; <a class="button"
					href="<c:url value="/confirmer/building/manage?campus_id=${room.id.campusId}&building_id=${room.id.buildingId}" />"><spring:message
						code="word.building" /></a> &raquo; <a class="button"
					href="<c:url value="/confirmer/room?campus_id=${room.id.campusId}&building_id=${room.id.buildingId}" />"><spring:message
						code="word.rooms" /></a> &raquo; <a class="button"
					href="<c:url value="/confirmer/room-attribute?campus_id=${room.id.campusId}&building_id=${room.id.buildingId}&room_id=${room.id.roomId}" />"><spring:message
						code="word.roomAttributes" /></a> &raquo; <a
					href="<c:url value="/confirmer/reservation-list-by-day-form?campus_id=${room.id.campusId}&building_id=${room.id.buildingId}&room_id=${room.id.roomId}" />"><spring:message
