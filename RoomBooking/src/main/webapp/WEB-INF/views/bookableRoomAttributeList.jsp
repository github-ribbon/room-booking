...
<div id="main_container">
	...
	<c:choose>
		...
		<c:otherwise>
			<nav id="context_menu">
				<a class="button"
					href="<c:url value="/client/campus/manage?campus_id=${campusId}" />"><spring:message
						code="word.campus" /></a> &raquo; <a class="button"
					href="<c:url value="/client/building?campus_id=${campusId}" />"><spring:message
						code="word.buildings" /></a> &raquo; <a class="button"
					href="<c:url value="/client/building/manage?campus_id=${campusId}&building_id=${buildingId}" />"><spring:message
						code="word.building" /></a> &raquo; <a class="button"
					href="<c:url value="/client/room?campus_id=${campusId}&building_id=${buildingId}" />"><spring:message
						code="word.rooms" /></a> &raquo; <a class="button"
					href="<c:url value="/client/room/manage?campus_id=${campusId}&building_id=${buildingId}&room_id=${roomId}" />"><spring:message
						code="word.room" /></a>
							...
							<table class="buttons_included">
								...
								<c:forEach items="${roomAttributes}" var="item">
									<tr>
										<td>
											<form
												action="<c:url value="/client/room-attribute/manage" />"
												method="get">
